...
app.get("*", (request, response) => response.sendFile(path.join(__dirname, "../../CRM001/index.html")));
app.use(errorHandler);

const port = Number(process.env.PORT || 4000);
module.exports = app.listen(port, () => console.log(`CRAM server listening on http://localhost:${port}`));
